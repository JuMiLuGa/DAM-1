...
//		lstProductos.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		...
		btnEliminar.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				int seleccion = JOptionPane.showConfirmDialog(null, "¿Desea realmente eliminar el producto seleccionado?", "Eliminar", JOptionPane.YES_NO_OPTION);
				if(seleccion == JOptionPane.YES_OPTION) {
					String sql = "DELETE FROM products WHERE productCode = '" + txtCodigo.getText() + "';";
	...
	private void actualizarEnBD() {
		String sentenciaSQL = "UPDATE products SET productName=?,"
				+ "productLine=?," 
				+ "productScale=?,"
				+ "productVendor=?,"
				+ "quantityInStock=?,"
